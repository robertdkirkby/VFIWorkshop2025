...
% ReturnFn
ReturnFn=@(h,aprime,a,sigma,psi,eta,w,r,kappa_j,agej, Jr)...
    WorkshopModel2_ReturnFn(h,aprime,a,sigma,psi,eta,w,r,kappa_j,agej, Jr);
...
FnsToEvaluate.earnings=@(h,aprime,a,w,kappa_j) w*kappa_j*h; % w*kappa_j is the labor earnings
