% Workshop Model 17
% Calibration: Model is just same as Workshop Model 3
% First part of code is just copy paste to solve Workshop Model 3.
% Skip to 'Start on the calibration' (line 106ish)
...
caliboptions=struct();
% caliboptions.fminalgo=4; % 4: CMA-ES, slow but robust
% caliboptions.constrainpositive={'beta','sigma'};
[CalibParams,calibsummary]=CalibrateLifeCycleModel(CalibParamNames,TargetMoments,n_d,n_a,n_z,N_j,d_grid, a_grid, z_grid, pi_z, ReturnFn, Params, DiscountFactorParamNames, jequaloneDist, AgeWeightsParamNames, [], FnsToEvaluate, caliboptions, vfoptions,simoptions);

% And we get the correct answers
CalibParams % shows beta=0.98 and sigma=2
