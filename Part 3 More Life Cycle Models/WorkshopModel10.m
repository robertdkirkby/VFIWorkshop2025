% Workshop Model 10
% Gul-Pesendorfer Preferences

%% Setup for Gul-Pesendorfer preferences
...
% Set up the temptation function (and associated parameters)

% Set up the temptation function in terms of (d,aprime,a,z) doing this is a lot like just a variant of the return function
vfoptions.temptationFn=@(h,aprime,a,z,w,sigmatempt,scaletemptation,agej,Jr,r,kappa_j) WorkshopModel10_TemptationFn(h,aprime,a,z,w,sigmatempt,scaletemptation,agej,Jr,r,kappa_j);

% The temptation parameters are
