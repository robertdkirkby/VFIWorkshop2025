...
% Divide-and-conquer will apply to the first of the two, so is important that housing is the second endogenous state (as it has less points, so we want to use divide-and-conquer on assets)
...
vfoptions.divideandconquer=1; % use divide and conquer in the first of the two endogenous states
tic;
